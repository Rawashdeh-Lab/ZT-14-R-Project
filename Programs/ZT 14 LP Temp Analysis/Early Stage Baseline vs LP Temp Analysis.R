...
# Baseline Data
BaselineData <- vroom('Raw Data/Experimental Group 3/ExperimentalGroupThree_4s_SD_Baseline_TempAct.csv.gz') %>%
  mutate(Condition = "Baseline")

# ZT 14 LP Data
ZT14LPData <- vroom('Raw Data/Experimental Group 3/ExperimentalGroupThree_4s_ZT14LP_TempAct.csv.gz')%>%
